	...
	\subsubsection{Nichtinvertierender Verstärker}
      ...
      \end{minipage}\\
		...
		Nichtinvertierender Schmitt-Trigger\\
			\begin{minipage}{9cm}
	          	\includegraphics[width=8cm]{./images/n-schmitt.png} 
	        \end{minipage}
			\begin{minipage}{9cm}
	          	\includegraphics[width=4cm]{./images/n-schmitt-kennlinie.png} 
	        \end{minipage}\\
		Invertierender Schmitt-Trigger\\
			\begin{minipage}{9cm}
	          	\includegraphics[width=8cm]{./images/i-schmitt.png} 
	        \end{minipage}
			\begin{minipage}{9cm}
	          	\includegraphics[width=4cm]{./images/i-schmitt-kennlinie.png} 
	        \end{minipage}\\
